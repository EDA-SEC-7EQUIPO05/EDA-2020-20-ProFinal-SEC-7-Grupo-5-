...
def newAnalyzer():
    analyzer = {'TaxiNum': 0, 'ServiceNum':0, 'TaxiPQ': None, 'ServicePQ': None, 'PointsTree': None}
    analyzer['TaxiPQ'] = {'PQ': ipq.newIndexMinPQ(compareCompanies), 'Map': m.newMap(numelements=40000, comparefunction=compareCompanies)}
